...
class LoadModuleStructureData extends MaderaFixtures {
    ...
    public function load(ObjectManager $manager) {
        ...
        $struct1MurDroit->setModule($this->getReference(LoadModuleData::MURS_DROIT))
        ...
        $struct2MurDroit->setModule($this->getReference(LoadModuleData::MURS_DROIT))
            ->setComponent($this->getReference(LoadComponentData::POLYSTYRENE_EXPANSE))
